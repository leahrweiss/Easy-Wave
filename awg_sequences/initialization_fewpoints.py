...
def genseq(buffer_t = 0, init_t =500e-6, read_t = 10e-6, reset_t = 1e-2, tau = 10e-6, rate = 1e7):
	...
	rtimes = np.array([0,5e-6,10e-6,15e-6,20e-6,30e-6,430e-6,440e-6,450e-6,490e-6])
	...
	writer.generate_and_upload('192.168.0.251', 'temp/initialization_6pinit_4pfin.awg',rate,limits=limits_awg)
	return writer
